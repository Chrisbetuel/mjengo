...
<head>
    ...
    <title>Direct Purchase - <?php echo SITE_NAME; ?></title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="direct_purchase.php"><?php echo __('direct_purchase'); ?></a></li>
                    <?php if (isLoggedIn()): ?>
    ...
    <section class="page-header">
        <div class="container">
            <div class="page-header-content">
                <h1 class="page-title"><?php echo __('direct_purchase_title'); ?></h1>
                <p class="page-subtitle"><?php echo __('direct_purchase_subtitle'); ?></p>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <?php if (empty($materials)): ?>
                <div class="empty-state">
                    ...
                    <p>Building materials will be available soon. Check back later for our latest offerings!</p>
                    ...
                    <?php foreach ($materials as $material): ?>
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card material-card h-100">
                                ...
                                <?php endif; ?>
                                <div class="material-badge">Direct Buy</div>
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="mt-auto text-center">
                                        ...
                                        <?php if (isLoggedIn()): ?>
                                            <button class="btn-buy" onclick="purchaseMaterial(<?php echo $material['id']; ?>, '<?php echo addslashes(getMaterialName($material)); ?>', <?php echo $material['price']; ?>)">
                                                <i class="fas fa-credit-card me-2"></i> Pay Now
                                            </button>
                                        <?php else: ?>
                                            <a href="login.php?redirect=direct_purchase&material_id=<?php echo $material['id']; ?>" class="btn-login">
    ...
    <section class="how-it-works">
        <div class="container">
            <div class="section-title">
                <h2><?php echo __('how_direct_purchase_works'); ?></h2>
                <p class="lead"><?php echo __('simple_steps_immediate_payment'); ?></p>
            </div>
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    <div class="step-card animate-on-scroll">
                        ...
                        <h5><?php echo __('pay_in_full'); ?></h5>
                        <p><?php echo __('confirm_purchase'); ?></p>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="step-card animate-on-scroll">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="purchaseForm" method="POST" action="process_direct_purchase.php">
                        <input type="hidden" id="purchaseMaterialId" name="material_id">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="deliveryAddress" name="delivery_address" rows="3" required placeholder="Enter your complete delivery address"></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="phoneNumber" class="form-label">Phone Number</label>
                            <input type="tel" class="form-control" id="phoneNumber" name="phone_number" required placeholder="Enter your phone number for delivery updates">
                        </div>
    ...
    <script>
        ...
        function purchaseMaterial(id, name, price) {
            currentPrice = price;
            document.getElementById('purchaseMaterialId').value = id;
            
            const purchaseDetails = document.getElementById('purchaseDetails');
            purchaseDetails.innerHTML = `
                <div class="alert alert-danger border-0 rounded-3 mb-4" style="background: rgba(231, 76, 60, 0.1); border-left: 4px solid var(--danger) !important;">
                    <h6 class="fw-bold">${name}</h6>
                    <p class="mb-1">Unit Price: <strong>TSh ${price.toLocaleString()}</strong></p>
                    <p class="mb-0">You will pay the full amount for your selected quantity.</p>
                </div>
                <div class="total-price">
                    <h6>Total Amount</h6>
                    <p class="mb-0 fw-bold fs-5">TSh <span id="totalPrice">${price.toLocaleString()}</span></p>
                </div>
            `;
